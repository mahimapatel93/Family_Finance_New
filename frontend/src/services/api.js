...
export const authService = {
  ...
  restartTour:         ()                => api.post('/auth/onboarding/restart'),
};
...
export const familyService = {
  ...
  generateInvite:   ()       => api.post('/families/invite'),
  addMember:        (email)  => api.post('/families/members', { email }),
  removeMember:     (userId) => api.delete(`/families/members/${userId}`),
  joinFamily:       (code)   => api.post('/families/join', { inviteCode: code }),
};
